...
lazy_static::lazy_static! {
    ...
    pub static ref PROD_RENDEZVOUS_SERVER: RwLock<String> = RwLock::new("remote.factupos.com".to_owned());
    pub static ref EXE_RENDEZVOUS_SERVER: RwLock<String> = Default::default();
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Soporte Remoto Factupos".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["remote.factupos.com"];
pub const RS_PUB_KEY: &str = "Ka3nu6yPqf05OpwXeaMx6DqA7JKAXKl5oC58TKyf1WI=";
